...
public sealed class LiveTradingSupportTests
{
    ...
    [TestMethod]
    public void GivenDcaStrategy_WhenValidateLiveTrading_ThenReturnsUnsupported()
    {
        var config = new StrategyConfig
        {
        ...
        reason.Should().Be("Live DCA spot execution is not implemented yet. Use backtesting for DCA strategies.");
    }
}