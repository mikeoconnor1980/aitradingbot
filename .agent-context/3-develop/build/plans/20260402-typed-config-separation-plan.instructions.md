...
currentAgent: "None"
agentStartedAt: "2026-04-02T14:16:48Z"
status: "reviewed"
lastUpdated: "2026-04-02T14:21:40Z"
---
...
- [ ] Task 1.1: Create IStrategyConfig marker interface in TradingApp.Domain
...
- [ ] Task 1.2: Move OrderSide enum to TradingApp.Domain.Enums
...
- [ ] Task 1.3: Move FeeModel to TradingApp.Domain.Trading
...
- [ ] Task 1.4: Move BacktestEntryModes to TradingApp.Domain.Trading as EntryModes
...
- [ ] Task 1.5: Create ExecutionConfig record in TradingApp.Domain.Trading
...
- [ ] Task 1.6: Create GridStrategyConfig record in TradingApp.Domain.Trading
...
- [ ] Task 1.7: Update all using statements and fix compilation
...
- [ ] Task 1.8: Run build and all tests
...
- [ ] Task 2.1: Refactor IStrategyEngine and GridStrategyEngine
...
- [ ] Task 2.2: Refactor IGridController and GridController
...
- [ ] Task 2.3: Refactor StrategyScheduler
...
- [ ] Task 2.4: Refactor BacktestConfig
...
- [ ] Task 2.5: Refactor BacktestRunner
...
- [ ] Task 2.6: Refactor BacktestProcessorService.BuildConfig (temporary bridge)
...
- [ ] Task 2.7: Update pipeline tests
...
- [ ] Task 2.8: Run build and all tests
...
- [ ] Task 3.1: Delete old Application.Backtesting.Models.GridStrategyConfig
...
- [ ] Task 3.2: Update RunBacktestRequest with separate sections
...
- [ ] Task 3.3: Update BacktestsController mapping and validation
...
- [ ] Task 3.4: Update RunBacktestCommand and handler
...
- [ ] Task 3.5: Update BacktestRun entity
...
- [ ] Task 3.6: Update BacktestRunResponseMapper
...
- [ ] Task 3.7: Update BacktestRunResponse
...
- [ ] Task 3.8: Update BacktestProcessorService.BuildConfig (final form)
...
- [ ] Task 3.9: Update DbContext and add EF migration
...
- [ ] Task 3.10: Update API and controller tests
...
- [ ] Task 3.11: Run build and all tests
...
- [ ] Task 4.1: Update TypeScript models
...
- [ ] Task 4.2: Update backtest-form component
...
- [ ] Task 4.3: Update backtest-page component (prefill)
...
- [ ] Task 4.4: Run frontend build and lint
