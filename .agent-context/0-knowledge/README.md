...
| 39 | [Azure Secret Operations](39-azure-secret-operations.md) | Post-deployment secret-resolution validation, runtime smoke checks, and secret rotation runbooks for the Azure control plane |
