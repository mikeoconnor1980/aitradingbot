...
public sealed class WorkerBinanceSigningHandler : DelegatingHandler
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            throw new DomainException("No active Binance API credential is configured for the current agent.");
        }
