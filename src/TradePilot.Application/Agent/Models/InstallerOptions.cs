...
/// When <see cref="BlobServiceUri"/> is set, files are served from Azure Blob Storage.
...
public sealed class InstallerOptions
{
    ...
    /// <summary>
    /// Azure Blob Storage service URI. When set, the blob store is used instead of local disk.
    /// </summary>
