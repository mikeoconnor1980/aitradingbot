...
/// Reconnects with exponential backoff and relays events to SignalR via ISignalRPublisher.
/// </summary>
public sealed class UserEventStreamService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _wsClient.OnFillReceived(async fill =>
        {
            ...
            await _publisher.BroadcastFillEventAsync(fill, CancellationToken.None);
        });
        ...
        _wsClient.OnOrderUpdateReceived(async orderUpdate =>
        {
            ...
            await _publisher.BroadcastOrderUpdateAsync(orderUpdate, CancellationToken.None);
        });
        ...
        _wsClient.OnConnectionStateChanged(async state =>
        {
            ...
            await _publisher.BroadcastUserConnectionStatusAsync(status, CancellationToken.None);
        });
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            if (_retryCount > MaxRetryAttempts)
            {
                ...
                await _publisher.BroadcastUserConnectionStatusAsync(disconnectedStatus, CancellationToken.None);
            ...
            await _publisher.BroadcastUserConnectionStatusAsync(reconnectingStatus, CancellationToken.None);
