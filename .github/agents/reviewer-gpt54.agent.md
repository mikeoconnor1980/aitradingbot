...
description: "Adversarial code and plan reviewer using GPT-5.4. Use when: tribunal multi-model review, adversarial analysis, plan critique, code review, finding bugs and security issues."
